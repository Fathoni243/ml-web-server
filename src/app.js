...
(async () => {
    ...
    // Fungsi loadModel() yang sebelumnya dibuat mengembalikan Promise sehingga kita perlu menggunakan await.
	...
	// running server
    // Method .start() ketika menjalankan server juga berjalan secara asynchronous sehingga perlu menggunakan await.
	await server.start();
